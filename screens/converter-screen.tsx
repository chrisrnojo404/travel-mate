...
export default function ConverterScreen() {
  ...
  const helperText = useMemo(() => {
    ...
    if (loading) return 'Fetching the latest available exchange rate.';
    if (!rateData) return 'No exchange rate data is available yet.';
...
const styles = StyleSheet.create({
  ...
  amountPrefix: { color: colors.textSecondary, fontSize: 18, fontWeight: '700' },
  amountInput: { flex: 1, minHeight: 58, color: colors.textPrimary, fontSize: 24, fontWeight: '800', paddingLeft: spacing.sm },
  ...
  swapText: { color: colors.textDark, fontSize: 14, fontWeight: '800' },
  ...
  resultValue: { color: colors.textDark, fontSize: 32, fontWeight: '800', lineHeight: 38 },
  resultHelper: { color: '#48627a', fontSize: 14, lineHeight: 20 },
  resultTimestamp: { color: '#6c8297', fontSize: 12, lineHeight: 18 },
  loadingState: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  loadingText: { color: '#48627a', fontSize: 14, lineHeight: 20 },
